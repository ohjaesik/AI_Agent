...
def build_bootstrap_supervisor_graph():
    ...
    builder.add_node("company_profile_agent", company_profile_agent_node)
    builder.add_node("source_ingestion_agent", source_ingestion_agent_node)
    builder.add_node("process_discovery_agent", process_discovery_agent_node)
