...
NODE_AGENT_BINDINGS: dict[str, dict[str, str]] = {
    ...
    "process_analyzer": {
        ...
        "capability": "process_bottleneck_analysis",
    ...
    "llm_critic": {
        "agent_id": "evaluation_critic_agent",
        "capability": "llm_second_opinion",
        "node_role": "LLM 기반 보조 검토와 confidence calibration",
    },
    "agent_replan": {
        "agent_id": "evaluation_critic_agent",
        "capability": "bounded_replan",
    ...
    "poc_delivery_planner": {
        "agent_id": "delivery_orchestration_agent",
        "capability": "poc_delivery_planning",
